...
/**
 * BaseEmailVerNoTestEmailService.as
...
package com.cdyne{
	 ...
	 */ 
	public class BaseEmailVerNoTestEmail extends AbstractWebService
    {
		private var results:Object;
		private var schemaMgr:SchemaManager;
		private var BaseEmailVerNoTestEmailService:WSDLService;
		private var BaseEmailVerNoTestEmailPortType:WSDLPortType;
		private var BaseEmailVerNoTestEmailBinding:WSDLBinding;
		private var BaseEmailVerNoTestEmailPort:WSDLPort;
		private var currentOperation:WSDLOperation;
		private var internal_schema:BaseEmailVerNoTestEmailSchema;
		 ...
		 */
		public function BaseEmailVerNoTestEmail(destination:String=null, rootURL:String=null)
		{
			...
			internal_schema = new BaseEmailVerNoTestEmailSchema();
...
BaseEmailVerNoTestEmailService = new WSDLService("BaseEmailVerNoTestEmailService");
			BaseEmailVerNoTestEmailPort = new WSDLPort("BaseEmailVerNoTestEmailPort",BaseEmailVerNoTestEmailService);
        	BaseEmailVerNoTestEmailBinding = new WSDLBinding("BaseEmailVerNoTestEmailBinding");
	        BaseEmailVerNoTestEmailPortType = new WSDLPortType("BaseEmailVerNoTestEmailPortType");
       		BaseEmailVerNoTestEmailBinding.portType = BaseEmailVerNoTestEmailPortType;
       		BaseEmailVerNoTestEmailPort.binding = BaseEmailVerNoTestEmailBinding;
       		BaseEmailVerNoTestEmailService.addPort(BaseEmailVerNoTestEmailPort);
       		BaseEmailVerNoTestEmailPort.endpointURI = "http://ws.cdyne.com/emailverify/Emailvernotestemail.asmx";
       		if(this.endpointURI == null)
       		{
       			this.endpointURI = BaseEmailVerNoTestEmailPort.endpointURI; 
       		} 
       		
			var requestMessage:WSDLMessage;
	        var responseMessage:WSDLMessage;
//define the WSDLOperation: new WSDLOperation(methodName)
            var VerifyEmail:WSDLOperation = new WSDLOperation("VerifyEmail");
				//input message for the operation
    	        requestMessage = new WSDLMessage("VerifyEmail");
            				requestMessage.addPart(new WSDLMessagePart(new QName("http://ws.cdyne.com/","email"),null,new QName("http://www.w3.org/2001/XMLSchema","string")));
            				requestMessage.addPart(new WSDLMessagePart(new QName("http://ws.cdyne.com/","LicenseKey"),null,new QName("http://www.w3.org/2001/XMLSchema","string")));
                requestMessage.encoding = new WSDLEncoding();
                requestMessage.encoding.namespaceURI="http://ws.cdyne.com/";
			requestMessage.encoding.useStyle="literal";
	            requestMessage.isWrapped = true;
	            requestMessage.wrappedQName = new QName("http://ws.cdyne.com/","VerifyEmail");
                
                responseMessage = new WSDLMessage("VerifyEmailResponse");
            				responseMessage.addPart(new WSDLMessagePart(new QName("http://ws.cdyne.com/","VerifyEmailResult"),null,new QName("http://ws.cdyne.com/","ReturnIndicator")));
                responseMessage.encoding = new WSDLEncoding();
                responseMessage.encoding.namespaceURI="http://ws.cdyne.com/";
                responseMessage.encoding.useStyle="literal";				
				
	            responseMessage.isWrapped = true;
	            responseMessage.wrappedQName = new QName("http://ws.cdyne.com/","VerifyEmail");VerifyEmail.inputMessage = requestMessage;
	        VerifyEmail.outputMessage = responseMessage;
            VerifyEmail.schemaManager = this.schemaMgr;
            VerifyEmail.soapAction = "http://ws.cdyne.com/VerifyEmail";
            VerifyEmail.style = "document";
            BaseEmailVerNoTestEmailService.getPort("BaseEmailVerNoTestEmailPort").binding.portType.addOperation(VerifyEmail);
							SchemaTypeRegistry.getInstance().registerCollectionClass(new QName("http://ws.cdyne.com/","ArrayOfAnyType"),com.cdyne.ArrayOfAnyType);
							SchemaTypeRegistry.getInstance().registerClass(new QName("http://ws.cdyne.com/","ReturnIndicator"),com.cdyne.ReturnIndicator);}
		/**
		 * Performs the low level call to the server for the operation
		 * It passes along the headers and the operation arguments
		 * @param email* @param LicenseKey
		...
		public function verifyEmail(email:String,licenseKey:String):AsyncToken
		{
            ...
            out["email"] = email;
	            ...
	            currentOperation = BaseEmailVerNoTestEmailService.getPort("BaseEmailVerNoTestEmailPort").binding.portType.getOperation("VerifyEmail");
